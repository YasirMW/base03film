...
<body>
    ...
    <header>
        <div class="jumbotron" style="background-image: url(../../assets/img/popo.jpg);">
            <h1> Base03 RPL </h1>
    ...
    <main id="oma">
        <div id="content">
            ...
            if (empty($sin->tampil($_GET['id']))) {
             ...
             <h2 align="center">Merasa bosan? Sini, dengarkan lagu ini dulu<br><audio controls autoplay loop>
    <source src="../../assets/img/AUD-20231103-WA0003.mp3" type="audio/mpeg">
</audio><br>
<?php if ($_SESSION['data']['role'] == 'admin') {
     ?>
<a href="../V_barang.php"class="btn btn-primary btn-icon-split">Kembali</a>
<?php }else{ ?><a href="../V_barang_user.php"class="btn btn-primary btn-icon-split">Kembali</a><?php } ?>
</h2> 
             <?php   
            }else{
...
<?= $s->sinopsis_lagi ?>                </p>
            ...
            <center>
                <h2>Penutup</h2>
                <p>Bagaimana? Tertarik untuk mengulas cerita yang mengasyikan, mendebarkan, dan mencengangkan ini? Kami harap kalian akan menikmati Film ini dengan senang hati &#128522;.</p>
...
<?php
    ...
    <footer>
        <marquee direction=left>Copyright goes to >----> Base03 Community</marquee>
    </footer>
</body>
